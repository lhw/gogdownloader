...
namespace Posix {
	...
	public class FILE {
		...
		public size_t write([CCode (array_length = false)] uint8[] ptr, size_t size, size_t nmemb);
		[CCode (cname = "fread", instance_pos = -1)]
		public size_t read([CCode (array_length = false)] ref uint8[] ptr, size_t size, size_t nmemb);
	}
